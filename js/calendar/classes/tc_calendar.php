...
class tc_calendar{
	...
	function writeScript(){
		...
		if($this->date_picker){
			echo("<div class=\"date_picker\" style=\"position: relative; z-index: $this->zindex;\" id=\"container_".$this->objname."\" onmouseover=\"javascript:focusCalendar('$this->objname');\" onmouseout=\"javascript:unFocusCalendar('$this->objname', $this->zindex);\">");
	...
	function writeCalendarContainer(){
		...
		if($this->date_picker){
			...
			//if(is_file($this->icon)){
				$img_attribs = getimagesize(SWS_JS_PATH."calendar/images/iconCalendar.gif");
